...
var CreateCamera = function(gl, pos, target, fovRad, near, far, createDebugStaticObject)
{
    ...
    {
        for(var i=0;i<12;++i)
            debugStaticObject.push(CreateLine(gl, TransparentStaticObjectArray, CreateVec3(0.0, 0.0, 0.0), CreateVec3(0.0, 0.0, 0.0), 1.0, 1.0, CreateVec4(1.0, 1.0, 1.0, 1.0)));

        for(var i=0;i<6;++i)
            debugStaticObject2.push(CreateQuad(gl, TransparentStaticObjectArray, CreateVec3(0.0, 0.0, 0.0), CreateVec3(0.0, 0.0, 0.0), CreateVec3(1.0, 1.0, 1.0), CreateVec3(1.0, 1.0, 1.0), CreateVec4(1.0, 1.0, 1.0, 1.0)));
    }
